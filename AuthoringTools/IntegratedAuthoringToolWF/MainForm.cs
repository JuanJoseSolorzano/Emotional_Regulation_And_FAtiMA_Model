...
namespace IntegratedAuthoringToolWF
{
    public partial class MainForm : Form
    {
        ...
        private EmotionRegulationWF.MainForm _EmotionRegulation;
        ...
        public MainForm()
        {
            ...
            _EmotionRegulation = new EmotionRegulationWF.MainForm();
            _webForm.iat = this;
        ...
        private void OnAssetStorageChange()
        {
            ...
            _EmotionRegulation.AssetForRegulation = EmotionalAppraisalAsset.CreateInstance(_storage);
        ...
        protected void OnAssetDataLoaded(IntegratedAuthoringToolAsset asset)
        {
            ...
            FormHelper.ShowFormInContainerControl(this.tabControlIAT.TabPages[6], _EmotionRegulation);
        ...
        private void buttonContinue_Click(object sender, EventArgs e)
        {
            foreach (var ag in _agentsInSimulation)
            {
                ...
                if (decisions.Any())
                {
                    ...
                    //En este punto podría llamarse al constructor de EmotionRegulation
        ...
        private void buttonOpenAssetStorage_Click(object sender, EventArgs e)
        {
            ...
            if (aux != null)
            {
                ...
                try
                {
                    ...
                    //Refrescar los datos del emotion regulation
                }
                catch (Exception ex)
                {
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (aux != null)
            {
                try
                {
                    ...
                    //Refrescar los datos de la clase Emotion regualtion
                }
                catch (Exception ex)
                {
                    MessageBox.Show("Error: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void tabPageEA_Click(object sender, EventArgs e)
        {

        }

        private void dataGridPersonality_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        }
    }
}